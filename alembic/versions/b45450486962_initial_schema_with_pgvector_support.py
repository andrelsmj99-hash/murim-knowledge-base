...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_characters_canonical_name'), 'characters', ['canonical_name'], unique=False)
    ...
    sa.ForeignKeyConstraint(['headquarters_id'], ['locations.id'], ),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('character_id', 'related_character_id', 'relationship_type', name='uix_relationship')
    )
    ...
    sa.Column('relationship_type', sa.String(length=100), nullable=False),
    sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['related_organization_id'], ['organizations.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('organization_id', 'related_organization_id', 'relationship_type', name='uix_org_relationship')
    )
